...
async def credits(ctx, *, arg):  
  await ctx.send("main bot developer: zokluke#4082. People that helped contributored to the bot/progect on github. Link to the github page: https://github.com/zokluke/FTABot") #hi
